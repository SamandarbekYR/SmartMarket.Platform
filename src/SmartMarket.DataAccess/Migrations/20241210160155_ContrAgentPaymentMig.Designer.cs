...
namespace SmartMarket.DataAccess.Migrations
{
    ...
    [Migration("20241210160155_ContrAgentPaymentMig")]
    partial class ContrAgentPaymentMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMarket.Domain.Entities.Orders.OrderProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SmartMarket.Domain.Entities.Scales.Scale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("SelectFilePath")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("select_file_path");
                    ...
                    b.Property<int>("UpdateTimeInterval")
                        .HasColumnType("integer")
                        .HasColumnName("update_time_interval");
            ...
            modelBuilder.Entity("SmartMarket.Domain.Entities.Orders.OrderProduct", b =>
                {
                    b.HasOne("SmartMarket.Domain.Entities.Orders.Order", "Order")
            ...
            modelBuilder.Entity("SmartMarket.Domain.Entities.PayDesks.PayDesk", b =>
                {
                    b.Navigation("ContrAgentPayments");
