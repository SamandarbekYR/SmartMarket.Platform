...
namespace SmartMarket.Desktop.Windows.Partners
{
    ...
    public partial class PartnersDetailWindow : Window
    {
        ...
        public void SetData(Partner partner)
        {
            ...
            lastPayment_TextBlock.Text = partner.LastPayment.ToString();
        }
        ...
        private async void btnPartnerToPay_MouseUp(object sender, MouseButtonEventArgs e)
        {
            MessageBox.Show("To'lov btn");
        }
