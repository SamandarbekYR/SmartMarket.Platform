...
/// </summary>
public partial class ShipmentSearchProductWindow : Window
{
    private readonly IProductService _productService;

    public ShipmentSearchProductWindow()
    {
        InitializeComponent();
    ...
    private void SetProduct(IList<FullProductDto> product)
    {
        ...
        if (product.Count > 0)
        {
            ...
            {
                ShipmentWindowSearchProduct searchProductComponent = new ShipmentWindowSearchProduct();
